namespace $.$$ {
	...
	export class $raggu_web_chat extends $.$raggu_web_chat {

		@ $mol_mem
		history( next?: Raggu_chat_item[] ): Raggu_chat_item[] {
			const stored = this.$.$mol_state_session.value( '$raggu_web_chat.history', next as any ) as Raggu_chat_item[] | null
